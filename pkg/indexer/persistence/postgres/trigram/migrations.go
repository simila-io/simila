...
create index if not exists "idx_index_record_segment" on "index_record" using gin ("segment" gin_trgm_ops);
...
func migrateUp(ctx context.Context, db *sql.DB) error {
	...
	migrs = append(migrs, initSchema("1699744513"))
	migrs = append(migrs, addTxtFormat("1699744514"))
